module.exports = {
    ...
    "rules": {
        ...
        "keyword-spacing": ["error", { "before": true, "after": true }], // Stellt sicher, dass Schlüsselwörter wie if,
        "space-infix-ops": "error", // Verlangt Leerzeichen um Operatoren
        "space-before-function-paren": ["error", "always"], // Erzwingt Leerzeichen vor den Klammern von Funktionsdefini
